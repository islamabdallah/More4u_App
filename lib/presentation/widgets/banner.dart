...
const double _kHeight = 14.0; // height of banner
...
/// Where to show a [MyBanner].
///
/// The start and end locations are relative to the ambient [Directionality]
/// (which can be overridden by [MyBanner.layoutDirection]).
...
/// Displays a [MyBanner] saying "DEBUG" when running in debug mode.
